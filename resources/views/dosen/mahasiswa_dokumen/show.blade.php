                        ...
                        @forelse($dokumen as $item)
                                                ...
                                                <div class="col-12 h-100">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="card">
                                                                @if($item->penilaian_dosen->where('dosen_id', auth()->user()->dosen->id)->count() == 0)
                                                                    <div class="card-header">
                                                                        <div class="text-end">
                                                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                                                data-bs-target="#penilaianDosen{{ $item->id }}">
                                                                            ...
                                                                            <tbody>
                                                                                @forelse($item->penilaian_dosen as $penilaian)
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-center" style="width: 100px">
                                                                                            @if($penilaian->dosen_id == auth()->user()->dosen->id)
                                                                                                <button type="button" class="btn btn-warning"
                                                                                                    data-bs-toggle="modal"
                                                                                                    data-bs-target="#editPenilaianDosen{{ $penilaian->id }}">
